...
export const workflowCache = {
    ...
    async saveWorkflow(workflowWrapper) {
        ...
        mainScriptUtils.debug('workflowCache - Essential workflow data saved: ', workflowItem.getFlag('critical-hits-revisited', 'cachedWorkflowData'));
    },
    /**
    ...
    async getWorkflow() {
        const workflowItem = await workflowCache.getWorkflowItem();
        mainScriptUtils.debug('workflowCache - Workflow retrieved: ', workflowItem.getFlag('critical-hits-revisited', 'cachedWorkflowData'));
        return workflowItem.getFlag('critical-hits-revisited', 'cachedWorkflowData');
    }
};
