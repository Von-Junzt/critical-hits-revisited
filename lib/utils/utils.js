...
export const utils = {
    ...
    checkImmunity: async function (effect, targetUuid, danageType) {
        ...
        const hasDamageImmunity = target.system.traits.di.value.some(entry => entry === danageType.toLowerCase());
