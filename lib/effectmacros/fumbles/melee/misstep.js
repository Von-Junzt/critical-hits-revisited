...
export async function misstep(effect, fumbleToken) {
    ...
    if (attackerWeapon) {
        ...
        ChatMessage.create({ content: `${fumbleToken.name} missteps, allowing ${attackerToken.name} to make an opportunity attack! But they have no melee weapon equipped to attack with.`});
