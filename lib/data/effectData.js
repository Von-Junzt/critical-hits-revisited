export const effectData = {
    ablaze: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "game.critsRevisited.animationUtils.playAnimation('generic_fire', token);"
                }
            }
        },
        "name": "Ablaze",
    ...
    armordamaged1: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "game.critsRevisited.animationUtils.playAnimation('generic_acid', token);"
                }
            }
        },
    ...
    dazzled: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "game.critsRevisited.animationUtils.playAnimation('generic_radiant', token);"
                }
            }
        },
        "name": "Dazzled",
    ...
    nauseous: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "game.critsRevisited.animationUtils.playAnimation('generic_poison', token);"
                }
            }
        },
        "name": "Nauseous",
