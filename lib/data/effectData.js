export const effectData = {
    ...
    acidbath: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.acidBath(actor)"
                }
            },
        },
        "name": "Acid Bath",
    ...
    festered: {
        ...
        "flags": {
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.festered(effect);"
                }
            },
            "dae": {
                "disableIncapacitated": false,
    ...
    sparksfly: {
        "changes": [],
        "description": "<p>You may choose one other creature within 15 ft. of the victim. That creature must succeed on a Dexterity saving throw (DC 14) or take half as much damage as the result for your critical hit.</p>",
        "disabled": false,
        "duration": {
            "seconds": null
        },
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.sparksFly(effect);"
                }
            }
        },
        "name": "Sparks Fly",
    ...
    tokenvision: {
        ...
        "description": "<p></p><p>Enables the vision mode for the selected token.</p><p></p>",
        "disabled": false,
        "duration": {
            "rounds": null,
            "seconds": null,
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "if(!token.document.sight.enabled){\n    const updates = [{_id: token.id, \"sight.enabled\": !token.document.sight.enabled}];\n    await canvas.scene.updateEmbeddedDocuments(\"Token\", updates);\n    ui.notifications.info(\"Token Vision enabled\");\n} else {\n    ui.notifications.warn(\"Token Vision is already enabled\");\n}\n\n"
                },
                "onDelete": {
        ...
        "statuses": [],
        "_stats": {
            "compendiumSource": "Item.KScMomjnVjU3eBKs.ActiveEffect.73Hy2ZJbShOJ3beJ",
            "duplicateSource": null,
            "coreVersion": "12.331",
            "systemId": "dnd5e",
            "systemVersion": "3.3.1",
            "createdTime": 1724333034840,
            "modifiedTime": 1724780966485,
            "lastModifiedBy": "byW8uRmdCnHPlu8H"
        },
