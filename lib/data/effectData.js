export const effectData = {
    ...
    acidbath: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critCheckWorkflow.effectMacros.acidBath(actor)"
                }
            },
        },
        "name": "Acid Bath",
    ...
    decapitated: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critCheckWorkflow.effectMacros.decapitated(actor)"
                }
            },
            "exportSource": {
    ...
    festered: {
        "changes": [
            {
                key: "flags.critical-hits-revisited.festered",
                mode: 5,
                value: "1",
                priority: 20
            }
        ...
        "flags": {
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critCheckWorkflow.effectMacros.festered(actor, 'add', workflow);"
                },
                'onDelete': {
                    "script": "await game.critCheckWorkflow.effectMacros.festered(actor, 'remove', workflow);"
                }
            },
            "dae": {
                "disableIncapacitated": false,
