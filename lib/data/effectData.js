export const effectData = {
    ...
    acidbath: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.acidBath(actor, effect);"
                }
            },
        },
        "name": "Acid Bath",
    ...
    electricarc: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.sparksFly(effect, 18);"
                }
            }
        },
        "name": "Electric Arc",
    ...
    litup: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.litUp(effect);"
                }
            }
        },
        "name": "Lit Up",
    ...
    sparksfly: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.sparksFly(effect, 14);"
                }
            }
        },
        "name": "Sparks Fly",
