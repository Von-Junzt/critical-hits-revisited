export const effectData = {
    ...
    festered: {
        ...
        "flags": {
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.festered(actor, effect);"
                }
            },
            "dae": {
                "disableIncapacitated": false,
    ...
    sentreeling: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "game.critsRevisited.socket.executeAsGM('sentReeling', {effect: effect, token: token});"
                }
            },
            "exportSource": {
                "world": "die-vergessenen-reiche-reworked",
