export const effectData = {
    ...
    acidbath: {
        ...
        "img": "modules/critical-hits-revisited/assets/img/armor_damaged.webp",
        "type": "base",
        "system": {},
        "sort": 0
    },
    ...
    festered: {
        ...
        "flags": {
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.festered(effect, token);"
                }
            },
            "dae": {
                "disableIncapacitated": false,
    ...
    multipleinjuries: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.multipleInjuries(effect, token);"
                }
            },
    ...
    severlywounded: {
        ...
        "flags": {
            ...
            "effectmacro": {
                "onCreate": {
                    "script": "await game.critsRevisited.effectMacros.severlyWounded(effect, token);"
                }
            },
        },
