...
export const critCheckWorkflow = {
    ...
    /**
     * Handeles the critical hit events for a given array of targets.
     ...
     * The passed argument may seem redundant and is a remain of an earlier version. Since we pass the complete workflow object,
     * we would not need this. I will change this in the future.
     * @param workflow {workflow} The Midi-QOL workflow object of the current item roll.
     * @returns {Promise<boolean>}
     */
